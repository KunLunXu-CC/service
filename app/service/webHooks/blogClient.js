...
module.exports = async ({ body, header }) => {
  ...
  // 2. 进入项目目录
  shell.cd('html');
  console.log('1. [success] 进入项目目录'.green);
  ...
  console.log('2. [success] 撤销 git 的所有本地修改成功'.green);
  ...
  console.log('3. [success] 拉取代码成功'.green);
  ...
  console.log('4. [success] 安装依赖成功'.green);
  ...
  console.log('6. [success] 打包编译成功'.green);

  // 7. 设置权限
  shell.chmod(755, '-R', '.');
  console.log('7. [success] 设置权限成功'.green);
